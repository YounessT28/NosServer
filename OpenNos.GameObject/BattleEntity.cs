                ...
                if (teamCheck)
                {
                    switch (EntityType)
                    {
                        case EntityType.Player:
                            return (1 + Character.Mates.Count(m => m.IsTeamMember || m.IsTemporalMate)) * 5;
                    ...
                    case EntityType.Player:
                        {
                            ...
                            if (MapInstance.MapInstanceId == ServerManager.Instance.ArenaInstance.MapInstanceId
                             && MapInstance.MapInstanceId == ServerManager.Instance.ArenaInstance2.MapInstanceId && ((MapInstance.Map.JaggedGrid[Character.PositionX][Character.PositionY]?.Value != 0 && (MapInstance.Map.JaggedGrid[Character.PositionX][Character.PositionY]?.Value != 16 || Character.PositionY == 35))
