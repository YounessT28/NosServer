                ...
                Observable.Timer(TimeSpan.FromMinutes(12)).Subscribe(X =>
                {
                    for (int d = 0; d < 180; d++)
                    {
                        if (!mapinstance.Item1.Monsters.Any(s => s.CurrentHp > 0))
                        {
                            ...
                            {
                                cli.Character.GenerateFamilyXp(cli.Character.Level * 40);
                                cli.Character.GetReputation(cli.Character.Level * 500);
                ...
                switch (instantbattletype)
                {
                    ...
                    case 80:
                        switch (wave)
                        {
                            ...
                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 120000));
                                dropParameters.AddRange(generateDrop(map, 1011, 15, 5));
                            ...
                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 30, 200000));
