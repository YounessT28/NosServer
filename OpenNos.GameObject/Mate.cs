...
namespace OpenNos.GameObject
{
    public class Mate : MateDTO
    {
        ...
        public void RemoveTeamMember(bool maxHpMp = true)
        {
            ...
            Owner.Session.Character.RemoveBuff(3000);
            Owner.Session.Character.RemoveBuff(3001);
            Owner.Session.Character.RemoveBuff(3002);
            Owner.Session.Character.RemoveBuff(3003);
            Owner.Session.Character.RemoveBuff(3004);
            Owner.Session.Character.RemoveBuff(3005);
            Owner.Session.Character.RemoveBuff(3006);
            Owner.Session.Character.RemoveBuff(3007);
            Owner.Session.Character.RemoveBuff(3008);
            Owner.Session.Character.RemoveBuff(3009);
            Owner.Session.Character.RemoveBuff(3010);
            Owner.Session.Character.RemoveBuff(3011);
            Owner.Session.Character.RemoveBuff(3012);
            Owner.Session.Character.RemoveBuff(3013);
            Owner.Session.Character.RemoveBuff(3014);
            Owner.Session.Character.RemoveBuff(3015);
            Owner.Session.Character.RemoveBuff(3016);
            Owner.Session.Character.RemoveBuff(3017);
            Owner.Session.Character.RemoveBuff(3018);
            Owner.Session.Character.RemoveBuff(3019);
            Owner.Session.Character.RemoveBuff(3020);
            Owner.Session.Character.RemoveBuff(3021);
            Owner.Session.Character.RemoveBuff(3022);
            Owner.Session.Character.RemoveBuff(3023);
            Owner.Session.Character.RemoveBuff(3024);
            Owner.Session.Character.RemoveBuff(3025);
            Owner.Session.Character.RemoveBuff(3026);
            Owner.Session.Character.RemoveBuff(3027);
            Owner.Session.Character.RemoveBuff(3028);
            Owner.Session.Character.RemoveBuff(3029);
            Owner.Session.Character.RemoveBuff(3030);
            Owner.Session.Character.RemoveBuff(3031);
            Owner.Session.Character.RemoveBuff(3032);
            Owner.Session.Character.RemoveBuff(3033);
            Owner.Session.Character.RemoveBuff(3034);
            #endregion
            StopLife();
