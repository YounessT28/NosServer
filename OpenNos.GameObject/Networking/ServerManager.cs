...
namespace OpenNos.GameObject.Networking
{
    public class ServerManager : BroadcastableBase
    {
        ...
        public List<CharacterTitlesDTO> CharacterTitles { get; private set; }
        ...
        public void Initialize()
        {
            ...
            try
            {
                ...
                if (DAOFactory.MapDAO.LoadById(2005) != null)
                {
                    ArenaInstance = GenerateMapInstance(2005, MapInstanceType.NormalInstance, new InstanceBag());
                ...
                if (DAOFactory.MapDAO.LoadById(30008) != null)
                {
                    ...
                    Console.WriteLine($"[Load] The Ventus Arena has been loaded");
                    ArenaInstance.CreatePortal(portal);
                }
                #endregion
