...
namespace OpenNos.GameObject.Helpers
{
    public class EventHelper
    {
        ...
        public static void GenerateFamilyEvent(EventType type, long familyId, string familyName)
        {
            if (!ServerManager.Instance.StartedEvents.Contains(type))
            {
                Task.Factory.StartNew(() =>
                {
                    ...
                    switch (type)
                    {
                        case EventType.FAMILYRAID:
                            FamilyRaid.GenerateFamilyRaid(familyId, familyName);
                            break;
                    }
                });
            }
                                    ...
                                    if (client != null)
                                    {
                                        ...
                                        if (fam != null)
                                        {
                                            ...
                                            CommunicationServiceClient.Instance.SendMessageToCharacter(new SCSCharacterMessage
                                            {
                                                ...
                                                Message = "The Glacernon Raid was successful",
